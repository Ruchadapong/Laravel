...
<div class="page-wrapper">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="card">
                    <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('add-booking') }}" name="add_booking" id="add_booking">{{ csrf_field() }}
                        <div class="card-body">
                        ...
                        @endif
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                        <input type="text" name="user_id" class="form-control" id="user_id" title="Enter User ID" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email1" class="col-sm-3 text-right control-label col-form-label">User Email</label>
                                <div class="col-sm-6">
                                        <input type="email" name="booking_email" class="form-control" id="booking_email" title="Enter User Email" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email1" class="col-sm-3 text-right control-label col-form-label">User Name</label>
                                <div class="col-sm-6">
                                        <input type="text" name="booking_name" class="form-control" id="booking_name" title="Enter User Name" required>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="email1" class="col-sm-3 text-right control-label col-form-label">User Telephone</label>
                                <div class="col-sm-6">
                                        <input type="text" name="booking_tel" class="form-control" id="booking_tel" title="Enter User Telephone" maxlength="10" required>
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <select type="text" name="status" class="f1-email form-control" id="status">
                                        <option value="รอหลักฐานการโอน" selected>รอหลักฐานการโอน</option>
