...
<div class="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="card">
                        <form enctype="multipart/form-data" class="form-horizontal" method="post" action="{{ url('add_package') }}" name="add_package" id="add_package">{{ csrf_field() }}
                            <div class="card-body">
                            ...
                            @endif
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="pack_name" class="form-control" id="pack_name" title="Enter package name" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="lname" class="col-sm-3 text-right control-label col-form-label">Package Time</label>
                                    <div class="col-sm-6">
                                            <input type="text" name="pack_time" class="form-control" id="pack_time" title="Enter package time" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="email1" class="col-sm-3 text-right control-label col-form-label">Package Cost</label>
                                    <div class="col-sm-6">
                                            <input type="text" name="pack_cost" class="form-control" id="pack_cost" title="Enter package cost" required>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label for="cono1" class="col-sm-3 text-right control-label col-form-label">Package Description</label>
                                    <div class="col-sm-6">
                                        <textarea class="form-control" name="pack_description" id="pack_description"></textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
